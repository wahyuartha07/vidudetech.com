    ...
    <article class="contanier" id="belajar">
        <section class="container2">
            <div class="judul-Course">
                <h2 class="judul" id="course">Prinsip Kedekatan Spasial <br> Dalam Desain Visual</h2>
            </div>
            <div class="ppt">
                <iframe loading="lazy" class="ppt1" src="https:&#x2F;&#x2F;www.canva.com&#x2F;design&#x2F;DAFxZxT3eS0&#x2F;view?embed" allowfullscreen="allowfullscreen" allow="fullscreen">
                </iframe>
            </div>
