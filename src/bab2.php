...
<body id="main">
    ...
    <article class="contanier" id="belajar">
        <section class="container2">
            ...
            <h2 class="judul" id="course">Prinsip Kedekatan Spasial Relvan</h2>
            </div>
            <div class="ppt">
                <iframe width="1000" height="600" src="https://www.youtube.com/embed/ZyLWiSg1M_U?si=1jryL_L-OE3P5U5J" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
            </div>
        ...
        <section class="button-kuis">
                <button class="kuis" onclick="window.location.href='kuis2.php'" id="kuis">Kuis</button>
        </section>
    </article>
    <!-- Belajar end -->
